...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  React is a Javascript library that was created to reduce repetition of code when building single-page applications.
1. Describe component state.
  A component state is data that is expected to change. Setting a state allows you to predict changes and manage responses and side effects of changes in data. 
1. Describe props.
  Props are function arguments in Javascript that are passed to components and also act as HTML attributes. 
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  Side effects are responses to a change in data. You can manage side effects with useEffect(). This allows you to create a certain reaction when something changes and avoid things like infinite loops.
